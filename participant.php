...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO participants (name, mobile, class, department, event_id) 
...
<body>
    ...
    <div class="form-container">
        ...
        <h2 class="form-title">Participant Form</h2>
        <form action="participant.php?event_id=<?php echo $event_id; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="participantName" name="name" placeholder="Enter your name" required minlength="3">
            </div>
            <div class="mb-3">
                <label for="participantMobile" class="form-label">Mobile Number</label>
                <input type="text" class="form-control" id="participantMobile" name="mobile" placeholder="Enter your mobile number" required minlength="10" maxlength="10" pattern="\d{10}">
            </div>
            <div class="mb-3">
                <label for="participantClass" class="form-label">Class</label>
                <select class="form-control" id="participantClass" name="class" required>
            ...
            <div class="mb-3">
                <label for="participantDepartment" class="form-label">Department</label>
                <select class="form-control" id="participantDepartment" name="department" required>
