...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (isset($_POST["login"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $_SESSION['stud_id'] = $row['stud_id']; // Ensure stud_id is stored in session
            echo "<script>alert('Login successful'); window.location.href='fetch_posts.php';</script>";
        } else {
            // Login failed
            ...
            <div class="tab-pane fade show active" id="signup" role="tabpanel" aria-labelledby="signup-tab">
                ...
                <form action="std_signup.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="studentName" name="name" placeholder="Enter your name" required minlength="3">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="studentPassword" name="password" placeholder="Enter your password" required minlength="6">
                    </div>
